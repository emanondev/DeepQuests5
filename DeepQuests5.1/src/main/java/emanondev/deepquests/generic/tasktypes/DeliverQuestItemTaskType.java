...
public class DeliverQuestItemTaskType<T extends User<T>> extends ATaskType<T> {
	...
	public class DeliverQuestItemTask extends ATask<T> {
		...
		private NPCData<T, DeliverQuestItemTask> npcData = null;
		private QuestItemData<T, DeliverQuestItemTask> itemData = null;
		...
		public DeliverQuestItemTask(int id, Mission<T> mission, YMLSection section) {
			...
			npcData = new NPCData<T, DeliverQuestItemTask>(this, getConfig().loadSection(Paths.TASK_INFO_NPCDATA));
			itemData = new QuestItemData<T, DeliverQuestItemTask>(this,
	...
	public String getDefaultUnstartedDescription(Task<T> task) {
		if (!(task instanceof DeliverQuestItemTaskType.DeliverQuestItemTask))
			return null;
		DeliverQuestItemTask t = (DeliverQuestItemTask) task;
