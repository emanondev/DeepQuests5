...
public class FailQuestRewardType<T extends User<T>> extends ARewardType<T> {
	...
	public List<String> getDescription() {
		return Arrays.asList("&7Fail selected quest for user");
	}
	...
	public String getDefaultFeedback(Reward<T> reward) {
		if (!(reward instanceof FailQuestRewardType.FailQuestReward))
			return null;
		FailQuestReward r = (FailQuestReward) reward;
