...
public class StartMissionRewardType<T extends User<T>> extends ARewardType<T> {
	...
	public List<String> getDescription() {
		return Arrays.asList("&7start selected mission for player");
	}
	...
	public class StartMissionReward extends AReward<T> {
		private TargetMissionData<T, StartMissionReward> missionData = null;
		...
		public StartMissionReward(int id, QuestManager<T> manager, YMLSection section) {
			...
			missionData = new TargetMissionData<T, StartMissionReward>(this,
	...
	public String getDefaultFeedback(Reward<T> reward) {
		if (!(reward instanceof StartMissionRewardType.StartMissionReward))
			return null;
		StartMissionReward r = (StartMissionReward) reward;
