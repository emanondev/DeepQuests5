...
public class CompleteMissionRewardType<T extends User<T>> extends ARewardType<T> {
	...
	public List<String> getDescription() {
		return Arrays.asList("&7complete selected mission for user");
	}
	...
	public class CompleteMissionReward extends AReward<T> {
		private TargetMissionData<T, CompleteMissionReward> missionData;
		...
		public CompleteMissionReward(int id, QuestManager<T> manager, YMLSection section) {
			...
			missionData = new TargetMissionData<T, CompleteMissionReward>(this,
	...
	public String getDefaultFeedback(Reward<T> reward) {
		if (!(reward instanceof CompleteMissionRewardType.CompleteMissionReward))
			return null;
		CompleteMissionReward r = (CompleteMissionReward) reward;
