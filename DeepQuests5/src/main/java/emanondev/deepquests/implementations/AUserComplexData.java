...
public abstract class AUserComplexData<T extends User<T>> extends AUserData<T> implements ComplexData<T> {
    ...
    public boolean isFailed() {
        return lastFailed > lastCompleted && lastFailed > lastStarted;
    }
    ...
    public boolean isStarted() {
        return lastStarted >= lastCompleted && lastStarted >= lastFailed && lastStarted > 0;
    }

    @Override
    public boolean isCompleted() {
        return lastCompleted > lastStarted && lastCompleted > lastFailed;
    }
